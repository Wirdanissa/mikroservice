...
ModelDetailProduk modelDetailProdukFromJson(String str) =>
    ModelDetailProduk.fromJson(json.decode(str));

String modelDetailProdukToJson(ModelDetailProduk data) =>
...
class ModelDetailProduk {
  ...
  factory ModelDetailProduk.fromJson(Map<String, dynamic> json) =>
      ModelDetailProduk(
